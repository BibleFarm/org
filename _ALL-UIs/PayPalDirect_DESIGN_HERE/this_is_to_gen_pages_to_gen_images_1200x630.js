...
var order_id = $('#order_id').val();
      ...
      $('#show_order_id').text(order_id);
		...
		var lets_add_the_rest_for_AD_01 = "</html>', function (err) {  if (err) throw err;  console.log('" + HtmlFileName_01 + " Saved!');}).then(() => {    console.log('I think " + HtmlFileName_01 + " is saved, so I\\\'m going to run the puppeteer now');const puppeteer = require('/home/aharon/node_modules/puppeteer'); (async () => { const browser = await puppeteer.launch({      defaultViewport: {width: 1200, height: 630}  }); const page = await browser.newPage(); await page.goto('file:///home/aharon/Documents/GitHub/org/_ALL-UIs/PayPalDirect_DESIGN_HERE/Pages_to_create_images/" + HtmlFileName_01 + ".html'); await page.waitForTimeout(100); await page.screenshot({ path: '//home/aharon/Documents/GitHub/org/support/pictures/" + HtmlFileName_01 + ".png' }); await browser.close(); })();  }).catch(er => {    console.log(er);  });";
...
//////////////////////////////////////////////////////
//////////////////////////////////////////////////////
var beforelandingPageFileName = "fsPromises.writeFile('//home/aharon/Documents/GitHub/org/support/visits/";
// insert file name here when I'm ready to put it all together
var betweenFileNameAndPageContent = ".html', '";
var landingPageContent = '<!DOCTYPE HTML><html lang="en-US" prefix="og: http://ogp.me/ns#" itemscope itemtype="http://schema.org/DefinedTerm"><head><meta charset="utf-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta content="width=device-width, initial-scale=1, maximum-scale=1" name="viewport"><meta content="no" name="msapplication-tap-highlight"><link href="/apple-touch-icon.png?v=057" rel="apple-touch-icon" sizes="180x180"><link href="/favicon-32x32.png?v=057" rel="icon" sizes="32x32" type="image/png"><link href="/favicon-194x194.png?v=057" rel="icon" sizes="194x194" type="image/png"><link href="/android-chrome-192x192.png?v=057" rel="icon" sizes="192x192" type="image/png"><link href="/favicon-16x16.png?v=057" rel="icon" sizes="16x16" type="image/png"><link href="/site.webmanifest?v=057" rel="manifest"><link href="/safari-pinned-tab.svg?v=057" rel="mask-icon"><link href="/favicon.ico?v=057" rel="shortcut icon"><meta content="BibleFarm.org" name="apple-mobile-web-app-title"><meta content="BibleFarm.org" name="application-name"><meta content="#000000" name="msapplication-TileColor"><meta content="/mstile-144x144.png?v=057" name="msapplication-TileImage"><meta content="#000000" name="theme-color"><link href="/apple-icon-57x57.png?v=057" rel="apple-touch-icon" sizes="57x57"><link href="/apple-icon-60x60.png?v=057" rel="apple-touch-icon" sizes="60x60"><link href="/apple-icon-72x72.png?v=057" rel="apple-touch-icon" sizes="72x72"><link href="/apple-icon-76x76.png?v=057" rel="apple-touch-icon" sizes="76x76"><link href="/apple-icon-114x114.png?v=057" rel="apple-touch-icon" sizes="114x114"><link href="/apple-icon-120x120.png?v=057" rel="apple-touch-icon" sizes="120x120"><link href="/apple-icon-144x144.png?v=057" rel="apple-touch-icon" sizes="144x144"><link href="/apple-icon-152x152.png?v=057" rel="apple-touch-icon" sizes="152x152"><link href="/favicon-96x96.png?v=057" rel="icon" sizes="96x96" type="image/png"><link href="/manifest.json?v=057" rel="manifest"><link href="/apple-touch-icon-57x57.png?v=057" rel="apple-touch-icon-precomposed" sizes="57x57"><link href="/apple-touch-icon-114x114.png?v=057" rel="apple-touch-icon-precomposed" sizes="114x114"><link href="/apple-touch-icon-72x72.png?v=057" rel="apple-touch-icon-precomposed" sizes="72x72"><link href="/apple-touch-icon-144x144.png?v=057" rel="apple-touch-icon-precomposed" sizes="144x144"><link href="/apple-touch-icon-60x60.png?v=057" rel="apple-touch-icon-precomposed" sizes="60x60"><link href="/apple-touch-icon-120x120.png?v=057" rel="apple-touch-icon-precomposed" sizes="120x120"><link href="/apple-touch-icon-76x76.png?v=057" rel="apple-touch-icon-precomposed" sizes="76x76"><link href="/apple-touch-icon-152x152.png?v=057" rel="apple-touch-icon-precomposed" sizes="152x152"><link href="/favicon-196x196.png?v=057" rel="icon" sizes="196x196" type="image/png"><link href="/favicon-96x96.png?v=057" rel="icon" sizes="96x96" type="image/png"><link href="/favicon-32x32.png?v=057" rel="icon" sizes="32x32" type="image/png"><link href="/favicon-16x16.png?v=057" rel="icon" sizes="16x16" type="image/png"><link href="/favicon-128.png?v=057" rel="icon" sizes="128x128" type="image/png"><meta content="BibleFarm.org" name="application-name"><meta content="#000000" name="msapplication-TileColor"><meta content="/mstile-144x144.png?v=057" name="msapplication-TileImage"><meta content="/mstile-70x70.png?v=057" name="msapplication-square70x70logo"><meta content="/mstile-150x150.png?v=057" name="msapplication-square150x150logo"><meta content="/mstile-310x150.png?v=057" name="msapplication-wide310x150logo"><meta content="/mstile-310x310.png?v=057" name="msapplication-square310x310logo"><meta content="summary_large_image" name="twitter:card"><meta content="Support the next visit ❤ DONATE" name="twitter:title"><meta content="Fulfilling Mat 25:31-40 one visit at a time" name="twitter:description"><meta content="@biblefarm" name="twitter:site"><meta content="@biblefarm" name="twitter:creator"><meta content="https://www.BibleFarm.org/support/pictures/' + HtmlFileName_01 + '.png" name="twitter:image:src"><meta content="Fulfilling Mat 25:31-40 one visit at a time" name="twitter:image:alt"><meta content="Support the next visit ❤ DONATE" property="og:title"><meta content="Fulfilling Mat 25:31-40 one visit at a time" property="og:description"><meta content="https://www.BibleFarm.org/support/pictures/' + HtmlFileName_01 + '.png" property="og:image"><meta content="image/png" property="og:image:type"><meta content="1200" property="og:image:width"><meta content="630" property="og:image:height"><meta content="https://BibleFarm.org/support/visits/' + HtmlFileName_01 + '.html" property="og:url"><meta content="BibleFarm.org - Fulfilling Mat 25:31-40 one visit at a time" property="og:site_name"><meta content="en_US" property="og:locale"><meta content="356077414586259" property="fb:admins"><meta content="205604789951385" property="fb:app_id"><meta content="website" property="og:type"><meta content="e3f86f5a3fa4999b9c17c1605383d4a8" name="p:domain_verify"><link href="images/torah_farm_launch_screen_640x1136.png" rel="apple-touch-startup-image"><meta content="#f00" name="theme-color"><meta content="#f00" name="msapplication-navbutton-color"><meta content="BibleFarm.org - Fulfilling Mat 25:31-40 one visit at a time - Hear, O Israel: The LORD our God <i>is</i> one LORD: [Deuteronomy 6 : 4]" name="description"><meta content="https://www.BibleFarm.org/support/pictures/' + HtmlFileName_01 + '.png" name="image"><title itemprop="name">BibleFarm.org - Fulfilling Mat 25:31-40 one visit at a time</title><script async src="https://www.googletagmanager.com/gtag/js?id=G-WZYYB7E825"></script><script>window.dataLayer = window.dataLayer || [];function gtag(){dataLayer.push(arguments);}gtag("js", new Date());gtag("config", "G-WZYYB7E825");</script><style>html, body {margin: 0 auto;font-family: sans-serif;font-size: 1px;}.v {width: 100%;text-align: center;}.wrap_image_sharing_ready_to_share {display: flex;width: 100%;text-align: center;flex-direction: row;flex-wrap: nowrap;align-content: center;justify-content: center;align-items: center;}.wrap_image_sharing_ready_to_share > div > img {width: 100%;max-width: 630px;}</style></head><body><div id="bg">bgc-0009</div><div class="v" itemprop="description">BibleFarm.org - Fulfilling Mat 25:31-40 one visit at a time - Hear, O Israel: The LORD our God <i>is</i> one LORD: [Deuteronomy 6 : 4]</div><div class="wrap_image_sharing_ready_to_share"><div><img data-pin-url="https://BibleFarm.org/support/visits/' + HtmlFileName_01 + '.html" data-pin-description="Support the next visit ❤ DONATE - Fulfilling Mat 25:31-40 one visit at a time. #biblefarm" itemprop="image" alt="Deuteronomy-6-4" src="https://www.BibleFarm.org/support/pictures/' + HtmlFileName_01 + '.png"></div></div><script>window.location.href = "https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=YCUGUZHYX5Y2Q&source=url";</script></body></html>';
...
var pathToSaveJSfile = "/home/aharon/Documents/GitHub/org/_ALL-UIs/PayPalDirect_DESIGN_HERE/Pages_to_create_images/";
...
var changeDirectory = "cd /home/aharon/Documents/GitHub/org/_ALL-UIs/PayPalDirect_DESIGN_HERE/Pages_to_create_images/\n";
