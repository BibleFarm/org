...
$('#fname_opt_2').val(idNeeded + '_opt_2');
});
...
var order_id = $('#order_id').val();
      ...
      $('#show_order_id').text(order_id);
		...
		var commentEndAD_01 = "\n// END AD_01\n\n";
		var HtmlFileName_01 = $('#order_id').val() + "-Option-2";
		...
		(function() {
		    ...
		    var create = document.getElementById('create_opt_2');
		    var fileContent = document.getElementById("fcontent_opt_2");

		    create.addEventListener('click', function() {
		        const fileName = document.getElementById("fname_opt_2").value;
		        document.getElementById("downloadlink_opt_2").setAttribute("download", fileName);
		        var link = document.getElementById('downloadlink_opt_2');
		        link.href = makeTextFile(fileContent.value);
		        // link.style.display = 'block';
		    }, false);
		})();
		////////////////////////////////////
		// END node JS file opt_2 ///////
		////////////////////////////////////
		////////////////////////////////////
