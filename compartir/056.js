...
if ($.trim($("#edited_app_name").text()) == "Su Nombre Va Aquí") {
...
///////////////////////////////////////////////////
/// BEGIN handle click on Su Nombre Va Aquí or logged in user  ///////
///////////////////////////////////////////////////
...
///////////////////////////////////////////////////
/// END handle click on Su Nombre Va Aquí or logged in user  ///////
///////////////////////////////////////////////////
...
$(document).ready(function() {
  ...
  console.log(origin);
    ...
    if( (url == "https://www.biblefarm.org/app/#login" ) && ($("#edited_app_name").text() == "Su Nombre Va Aquí") ) {
...
$("body").find("button[data-provider-id='google.com']").find(".firebaseui-idp-text-long").text("Iniciar sesión con Google").css("text-shadow", "0px 0px 1px #000").css("font-family", "PT_Sans-Narrow-Web-Regular").css("font-size", "20px");
$("body").find("button[data-provider-id='facebook.com']").find(".firebaseui-idp-text-long").text("Iniciar sesión con Facebook").css("text-shadow", "1px 1px 1px #000").css("font-family", "PT_Sans-Narrow-Web-Regular").css("font-size", "20px");
$("body").find("button[data-provider-id='twitter.com']").find(".firebaseui-idp-text-long").text("Iniciar sesión con Twitter").css("text-shadow", "1px 1px 1px #000").css("font-family", "PT_Sans-Narrow-Web-Regular").css("font-size", "20px");
$("body").find("button[data-provider-id='password']").find(".firebaseui-idp-text-long").text("Iniciar sesión con Email").css("text-shadow", "1px 1px 1px #000").css("font-family", "PT_Sans-Narrow-Web-Regular").css("font-size", "20px");
}
}, 1000);
// after we signed out
