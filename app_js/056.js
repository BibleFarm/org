...
// offer I_need_help
$("#login_now").hide();
$("#continue_as_a_visitor_first").css("visibility", "hidden");
$("#I_need_help").show();
$("#I_need_help").on("click", function(e) {
$("body").find(".show_pure_chat").trigger({type: 'click', which: 1});
});
// offer fullscreen default is on
setTimeout(function() {
  if ($("#offer_fullscreen_mode_on").hasClass("active_switch")) {
    $(".wrap_fullscreen_offer").show("slow");
  }
}, 22000);
  ...
  // offer to continue_as_a_visitor or login_now
  $("#I_need_help").hide();
  $("#login_now").show();
  $("#continue_as_a_visitor_first").css("visibility", "visible");
...
////////////////////////////////////////////
  $("#to_search_en").one('click', function(e) {
    // user want to search
...
setTimeout(function() {
  ...
  $('#example-main tbody').on('click', 'tr td .w', function() {
    ...
    $("input.filter_en:text").val(wordToSearch);
  });
  //////////////////////////////////////////////
  //////////////////////////////////////////////
...
$(document).ready(function() {
  ...
  var table_nav_left_Books_status = $('#example-nav_left_Books_status').DataTable({
    ...
    "columnDefs": [{
      "render": function(data, type, row, full, meta) {
        return '<div id="table_nav_left_Books_status_row_0" class="status_styling">' + row[0] + '</div>';
      },
      "targets": 0,
      "visible": false
    }, {
      "render": function(data, type, row, full, meta) {
        return '<div id="table_nav_left_Books_status_row_3" class="status_styling looking_inside_text_align_left">filtering ' + row[3] + '</div>';
      },
      "targets": 1,
      "visible": true
    }]
  ...
  var table_nav_left_Chapters_status = $('#example-nav_left_Chapters_status').DataTable({
    ...
    "columnDefs": [{
      "render": function(data, type, row, full, meta) {
        return '<div id="table_nav_left_Chapters_status_row_0" class="status_styling">' + row[0] + '</div>';
      },
      "targets": 0,
      "visible": false
    }, {
      "render": function(data, type, row, full, meta) {
        return '<div id="table_nav_left_Chapters_status_row_2" class="status_styling">' + row[2] + '</div>';
      },
      "targets": 1,
      "visible": true
    }]
  ...
  var table_nav_left_Verses_status = $('#example-nav_left_Verses_status').DataTable({
    ...
    "columnDefs": [{
      "render": function(data, type, row, full, meta) {
        return '<div id="table_nav_left_Verses_status_row_0" class="status_styling">' + row[0] + '</div>';
      },
      "targets": 0,
      "visible": false
    }, {
      "render": function(data, type, row, full, meta) {
        return '<div id="table_nav_left_Verses_status_row_3" class="status_styling">' + row[3] + '</div>';
      },
      "targets": 1,
      "visible": true
    }]
  ...
  var table_browsing_mode_nav_left_Books_status = $('#example-browsing_mode_nav_left_Books_status').DataTable({
    ...
    "columnDefs": [{
      "render": function(data, type, row, full, meta) {
        return '<div id="table_browsing_mode_nav_left_Books_status_row_0" class="status_styling">' + row[0] + '</div>';
      },
      "targets": 0,
      "visible": false
    }, {
      "render": function(data, type, row, full, meta) {
        return '<div id="table_browsing_mode_nav_left_Books_status_row_3" class="status_styling looking_inside_text_align_left">' + row[3] + '</div>';
      },
      "targets": 1,
      "visible": true
    }]
  ...
  var table_browsing_mode_nav_left_Chapters_status = $('#example-browsing_mode_nav_left_Chapters_status').DataTable({
    ...
    "columnDefs": [{
      "render": function(data, type, row, full, meta) {
        return '<div id="table_browsing_mode_nav_left_Chapters_status_row_0" class="status_styling">' + row[0] + '</div>';
      },
      "targets": 0,
      "visible": false
    }, {
      "render": function(data, type, row, full, meta) {
        return '<div id="table_browsing_mode_nav_left_Chapters_status_row_2" class="status_styling">' + row[2] + '</div>';
      },
      "targets": 1,
      "visible": true
    }]
  ...
  var table_browsing_mode_nav_left_Verses_status = $('#example-browsing_mode_nav_left_Verses_status').DataTable({
    ...
    "columnDefs": [{
      "render": function(data, type, row, full, meta) {
        return '<div id="table_browsing_mode_nav_left_Verses_status_row_0" class="status_styling">' + row[0] + '</div>';
      },
      "targets": 0,
      "visible": false
    }, {
      "render": function(data, type, row, full, meta) {
        return '<div id="table_browsing_mode_nav_left_Verses_status_row_3" class="status_styling">' + row[3] + '</div>';
      },
      "targets": 1,
      "visible": true
    }]
...
$(document).ready(function() {
  ...
  $('.wrap_ref_body_welcome, .wrap_ref_body_analysis, .wrap_ref_body_lexicons, .wrap_ref_body_dictionaries, .wrap_ref_body_encyclopedias, .wrap_ref_body_topics, .wrap_ref_body_notes, .wrap_ref_body_highlights, .wrap_ref_body_bookmarks, .wrap_ref_body_post').perfectScrollbar({
    scrollXMarginOffset: 12,
    suppressScrollX: true
  });
...
var liSelectedChangeWrapAjaxedClonedStatus = $("li.selected a").text();
$("#wrap_ajaxed_cloned_status").html("<span id='browsing_inside'>browsing inside </span>" + liSelectedChangeWrapAjaxedClonedStatus);
...
$(document).ready(function() { // begin the document ready
  ...
  // $(".filter_es").css("color", "red");
  //         }
  //         if (searching_filters_width > 250) {
  // $(".searching_filters").show();
  // $(".filter_es").css("color", "blue");
  //         }
  //     });
  $(window).resize(function() {
    var searching_filters_width = $(".searching_filters").width();
  ...
  $(".wrap_input input.filter_es").hide();
  ...
  $(".config_reg_eng_only").on('click', function() {
    ...
    $("input.filter_es").removeClass("active").hide();
    $("input.filter_en").removeClass("active").show().addClass("active");
  ...
  $(".config_reg_esp_only").on('click', function() {
    ...
    $("input.filter_grk").removeClass("active").hide();
    $("input.filter_grk_tra").removeClass("active").hide();
    $("input.filter_es").removeClass("active").show().addClass("active");
    $("input.filter_en").removeClass("active").hide();
    $("input.filter_heb_tra").removeClass("active").hide();
    $("input.filter_heb").removeClass("active").hide();
  });
  ////////////////////////////////////////////////////
...
// handle changes
  $(".wrap_top_menu").find("#bgc-0001").on('click', function() {
    $(".wrap_top, .wrap_bot, .wrap_ajaxed, #wrap_ajaxed_cloned_status, #current_section, .wrap_nav_header, .wrap_nav_footer, .wrap_ref_header, .wrap_ref_footer, #example-nav_left_Books_status tbody td, #example-nav_left_Chapters_status tbody td, #example-nav_left_Verses_status tbody td, input.standard_input_reg, #example-nav_left_Teaching tbody td, #example-nav_left_FormerProphets tbody td, #example-nav_left_LatterProphets tbody td, #example-nav_left_TheTwelve tbody td, #example-nav_left_ScrollsOfTruth tbody td, #example-nav_left_FiveScrolls tbody td, #example-nav_left_OtherScrolls tbody td, #example-nav_left_Messiah tbody td, #example-nav_left_Emissaries tbody td, #example-nav_left_Assemblies tbody td, #example-nav_left_Disciples tbody td, #example-nav_left_Vision tbody td, #example-nav_left_Chapters tbody td, #example-nav_left_Verses tbody td, #s1 tbody td, #s2 tbody td, #s3 tbody td, #s4 tbody td, #s5 tbody td, #s6 tbody td, #s7 tbody td, #s8 tbody td, #s9 tbody td, #s10 tbody td, #s11 tbody td, #s12 tbody td, #example-browsing_mode_nav_left_Chapters tbody td, #example-browsing_mode_nav_left_Verses tbody td, .swiper_main_pagination, .show_sharing_options, .show_sending_options, .show_saving_options, ul.sm2-playlist-bd, .bd, .sm2-extra-controls, .sm2-inline-status, .sharing_modal_filter_mode, .fullscreen_offer, .sharing_modal_browsing_mode").removeClass("bgc-0001 bgc-0002 bgc-0003 bgc-0004 bgc-0005 bgc-0006 bgc-0007 bgc-0008 bgc-0009 bgc-0010 bgc-0011 bgc-0012 bgc-0013 bgc-0014 bgc-0015 bgc-0016").addClass("bgc-0001");
  ...
  $(".wrap_top_menu").find("#bgc-0002").on('click', function() {
    $(".wrap_top, .wrap_bot, .wrap_ajaxed, #wrap_ajaxed_cloned_status, #current_section, .wrap_nav_header, .wrap_nav_footer, .wrap_ref_header, .wrap_ref_footer, #example-nav_left_Books_status tbody td, #example-nav_left_Chapters_status tbody td, #example-nav_left_Verses_status tbody td, input.standard_input_reg, #example-nav_left_Teaching tbody td, #example-nav_left_FormerProphets tbody td, #example-nav_left_LatterProphets tbody td, #example-nav_left_TheTwelve tbody td, #example-nav_left_ScrollsOfTruth tbody td, #example-nav_left_FiveScrolls tbody td, #example-nav_left_OtherScrolls tbody td, #example-nav_left_Messiah tbody td, #example-nav_left_Emissaries tbody td, #example-nav_left_Assemblies tbody td, #example-nav_left_Disciples tbody td, #example-nav_left_Vision tbody td, #example-nav_left_Chapters tbody td, #example-nav_left_Verses tbody td, #s1 tbody td, #s2 tbody td, #s3 tbody td, #s4 tbody td, #s5 tbody td, #s6 tbody td, #s7 tbody td, #s8 tbody td, #s9 tbody td, #s10 tbody td, #s11 tbody td, #s12 tbody td, #example-browsing_mode_nav_left_Chapters tbody td, #example-browsing_mode_nav_left_Verses tbody td, .swiper_main_pagination, .show_sharing_options, .show_sending_options, .show_saving_options, ul.sm2-playlist-bd, .bd, .sm2-extra-controls, .sm2-inline-status, .sharing_modal_filter_mode, .fullscreen_offer, .sharing_modal_browsing_mode").removeClass("bgc-0001 bgc-0002 bgc-0003 bgc-0004 bgc-0005 bgc-0006 bgc-0007 bgc-0008 bgc-0009 bgc-0010 bgc-0011 bgc-0012 bgc-0013 bgc-0014 bgc-0015 bgc-0016").addClass("bgc-0002");
  ...
  $(".wrap_top_menu").find("#bgc-0003").on('click', function() {
    $(".wrap_top, .wrap_bot, .wrap_ajaxed, #wrap_ajaxed_cloned_status, #current_section, .wrap_nav_header, .wrap_nav_footer, .wrap_ref_header, .wrap_ref_footer, #example-nav_left_Books_status tbody td, #example-nav_left_Chapters_status tbody td, #example-nav_left_Verses_status tbody td, input.standard_input_reg, #example-nav_left_Teaching tbody td, #example-nav_left_FormerProphets tbody td, #example-nav_left_LatterProphets tbody td, #example-nav_left_TheTwelve tbody td, #example-nav_left_ScrollsOfTruth tbody td, #example-nav_left_FiveScrolls tbody td, #example-nav_left_OtherScrolls tbody td, #example-nav_left_Messiah tbody td, #example-nav_left_Emissaries tbody td, #example-nav_left_Assemblies tbody td, #example-nav_left_Disciples tbody td, #example-nav_left_Vision tbody td, #example-nav_left_Chapters tbody td, #example-nav_left_Verses tbody td, #s1 tbody td, #s2 tbody td, #s3 tbody td, #s4 tbody td, #s5 tbody td, #s6 tbody td, #s7 tbody td, #s8 tbody td, #s9 tbody td, #s10 tbody td, #s11 tbody td, #s12 tbody td, #example-browsing_mode_nav_left_Chapters tbody td, #example-browsing_mode_nav_left_Verses tbody td, .swiper_main_pagination, .show_sharing_options, .show_sending_options, .show_saving_options, ul.sm2-playlist-bd, .bd, .sm2-extra-controls, .sm2-inline-status, .sharing_modal_filter_mode, .fullscreen_offer, .sharing_modal_browsing_mode").removeClass("bgc-0001 bgc-0002 bgc-0003 bgc-0004 bgc-0005 bgc-0006 bgc-0007 bgc-0008 bgc-0009 bgc-0010 bgc-0011 bgc-0012 bgc-0013 bgc-0014 bgc-0015 bgc-0016").addClass("bgc-0003");
  ...
  $(".wrap_top_menu").find("#bgc-0004").on('click', function() {
    $(".wrap_top, .wrap_bot, .wrap_ajaxed, #wrap_ajaxed_cloned_status, #current_section, .wrap_nav_header, .wrap_nav_footer, .wrap_ref_header, .wrap_ref_footer, #example-nav_left_Books_status tbody td, #example-nav_left_Chapters_status tbody td, #example-nav_left_Verses_status tbody td, input.standard_input_reg, #example-nav_left_Teaching tbody td, #example-nav_left_FormerProphets tbody td, #example-nav_left_LatterProphets tbody td, #example-nav_left_TheTwelve tbody td, #example-nav_left_ScrollsOfTruth tbody td, #example-nav_left_FiveScrolls tbody td, #example-nav_left_OtherScrolls tbody td, #example-nav_left_Messiah tbody td, #example-nav_left_Emissaries tbody td, #example-nav_left_Assemblies tbody td, #example-nav_left_Disciples tbody td, #example-nav_left_Vision tbody td, #example-nav_left_Chapters tbody td, #example-nav_left_Verses tbody td, #s1 tbody td, #s2 tbody td, #s3 tbody td, #s4 tbody td, #s5 tbody td, #s6 tbody td, #s7 tbody td, #s8 tbody td, #s9 tbody td, #s10 tbody td, #s11 tbody td, #s12 tbody td, #example-browsing_mode_nav_left_Chapters tbody td, #example-browsing_mode_nav_left_Verses tbody td, .swiper_main_pagination, .show_sharing_options, .show_sending_options, .show_saving_options, ul.sm2-playlist-bd, .bd, .sm2-extra-controls, .sm2-inline-status, .sharing_modal_filter_mode, .fullscreen_offer, .sharing_modal_browsing_mode").removeClass("bgc-0001 bgc-0002 bgc-0003 bgc-0004 bgc-0005 bgc-0006 bgc-0007 bgc-0008 bgc-0009 bgc-0010 bgc-0011 bgc-0012 bgc-0013 bgc-0014 bgc-0015 bgc-0016").addClass("bgc-0004");
  ...
  $(".wrap_top_menu").find("#bgc-0005").on('click', function() {
    $(".wrap_top, .wrap_bot, .wrap_ajaxed, #wrap_ajaxed_cloned_status, #current_section, .wrap_nav_header, .wrap_nav_footer, .wrap_ref_header, .wrap_ref_footer, #example-nav_left_Books_status tbody td, #example-nav_left_Chapters_status tbody td, #example-nav_left_Verses_status tbody td, input.standard_input_reg, #example-nav_left_Teaching tbody td, #example-nav_left_FormerProphets tbody td, #example-nav_left_LatterProphets tbody td, #example-nav_left_TheTwelve tbody td, #example-nav_left_ScrollsOfTruth tbody td, #example-nav_left_FiveScrolls tbody td, #example-nav_left_OtherScrolls tbody td, #example-nav_left_Messiah tbody td, #example-nav_left_Emissaries tbody td, #example-nav_left_Assemblies tbody td, #example-nav_left_Disciples tbody td, #example-nav_left_Vision tbody td, #example-nav_left_Chapters tbody td, #example-nav_left_Verses tbody td, #s1 tbody td, #s2 tbody td, #s3 tbody td, #s4 tbody td, #s5 tbody td, #s6 tbody td, #s7 tbody td, #s8 tbody td, #s9 tbody td, #s10 tbody td, #s11 tbody td, #s12 tbody td, #example-browsing_mode_nav_left_Chapters tbody td, #example-browsing_mode_nav_left_Verses tbody td, .swiper_main_pagination, .show_sharing_options, .show_sending_options, .show_saving_options, ul.sm2-playlist-bd, .bd, .sm2-extra-controls, .sm2-inline-status, .sharing_modal_filter_mode, .fullscreen_offer, .sharing_modal_browsing_mode").removeClass("bgc-0001 bgc-0002 bgc-0003 bgc-0004 bgc-0005 bgc-0006 bgc-0007 bgc-0008 bgc-0009 bgc-0010 bgc-0011 bgc-0012 bgc-0013 bgc-0014 bgc-0015 bgc-0016").addClass("bgc-0005");
  ...
  $(".wrap_top_menu").find("#bgc-0006").on('click', function() {
    $(".wrap_top, .wrap_bot, .wrap_ajaxed, #wrap_ajaxed_cloned_status, #current_section, .wrap_nav_header, .wrap_nav_footer, .wrap_ref_header, .wrap_ref_footer, #example-nav_left_Books_status tbody td, #example-nav_left_Chapters_status tbody td, #example-nav_left_Verses_status tbody td, input.standard_input_reg, #example-nav_left_Teaching tbody td, #example-nav_left_FormerProphets tbody td, #example-nav_left_LatterProphets tbody td, #example-nav_left_TheTwelve tbody td, #example-nav_left_ScrollsOfTruth tbody td, #example-nav_left_FiveScrolls tbody td, #example-nav_left_OtherScrolls tbody td, #example-nav_left_Messiah tbody td, #example-nav_left_Emissaries tbody td, #example-nav_left_Assemblies tbody td, #example-nav_left_Disciples tbody td, #example-nav_left_Vision tbody td, #example-nav_left_Chapters tbody td, #example-nav_left_Verses tbody td, #s1 tbody td, #s2 tbody td, #s3 tbody td, #s4 tbody td, #s5 tbody td, #s6 tbody td, #s7 tbody td, #s8 tbody td, #s9 tbody td, #s10 tbody td, #s11 tbody td, #s12 tbody td, #example-browsing_mode_nav_left_Chapters tbody td, #example-browsing_mode_nav_left_Verses tbody td, .swiper_main_pagination, .show_sharing_options, .show_sending_options, .show_saving_options, ul.sm2-playlist-bd, .bd, .sm2-extra-controls, .sm2-inline-status, .sharing_modal_filter_mode, .fullscreen_offer, .sharing_modal_browsing_mode").removeClass("bgc-0001 bgc-0002 bgc-0003 bgc-0004 bgc-0005 bgc-0006 bgc-0007 bgc-0008 bgc-0009 bgc-0010 bgc-0011 bgc-0012 bgc-0013 bgc-0014 bgc-0015 bgc-0016").addClass("bgc-0006");
  ...
  $(".wrap_top_menu").find("#bgc-0007").on('click', function() {
    $(".wrap_top, .wrap_bot, .wrap_ajaxed, #wrap_ajaxed_cloned_status, #current_section, .wrap_nav_header, .wrap_nav_footer, .wrap_ref_header, .wrap_ref_footer, #example-nav_left_Books_status tbody td, #example-nav_left_Chapters_status tbody td, #example-nav_left_Verses_status tbody td, input.standard_input_reg, #example-nav_left_Teaching tbody td, #example-nav_left_FormerProphets tbody td, #example-nav_left_LatterProphets tbody td, #example-nav_left_TheTwelve tbody td, #example-nav_left_ScrollsOfTruth tbody td, #example-nav_left_FiveScrolls tbody td, #example-nav_left_OtherScrolls tbody td, #example-nav_left_Messiah tbody td, #example-nav_left_Emissaries tbody td, #example-nav_left_Assemblies tbody td, #example-nav_left_Disciples tbody td, #example-nav_left_Vision tbody td, #example-nav_left_Chapters tbody td, #example-nav_left_Verses tbody td, #s1 tbody td, #s2 tbody td, #s3 tbody td, #s4 tbody td, #s5 tbody td, #s6 tbody td, #s7 tbody td, #s8 tbody td, #s9 tbody td, #s10 tbody td, #s11 tbody td, #s12 tbody td, #example-browsing_mode_nav_left_Chapters tbody td, #example-browsing_mode_nav_left_Verses tbody td, .swiper_main_pagination, .show_sharing_options, .show_sending_options, .show_saving_options, ul.sm2-playlist-bd, .bd, .sm2-extra-controls, .sm2-inline-status, .sharing_modal_filter_mode, .fullscreen_offer, .sharing_modal_browsing_mode").removeClass("bgc-0001 bgc-0002 bgc-0003 bgc-0004 bgc-0005 bgc-0006 bgc-0007 bgc-0008 bgc-0009 bgc-0010 bgc-0011 bgc-0012 bgc-0013 bgc-0014 bgc-0015 bgc-0016").addClass("bgc-0007");
  ...
  $(".wrap_top_menu").find("#bgc-0008").on('click', function() {
    $(".wrap_top, .wrap_bot, .wrap_ajaxed, #wrap_ajaxed_cloned_status, #current_section, .wrap_nav_header, .wrap_nav_footer, .wrap_ref_header, .wrap_ref_footer, #example-nav_left_Books_status tbody td, #example-nav_left_Chapters_status tbody td, #example-nav_left_Verses_status tbody td, input.standard_input_reg, #example-nav_left_Teaching tbody td, #example-nav_left_FormerProphets tbody td, #example-nav_left_LatterProphets tbody td, #example-nav_left_TheTwelve tbody td, #example-nav_left_ScrollsOfTruth tbody td, #example-nav_left_FiveScrolls tbody td, #example-nav_left_OtherScrolls tbody td, #example-nav_left_Messiah tbody td, #example-nav_left_Emissaries tbody td, #example-nav_left_Assemblies tbody td, #example-nav_left_Disciples tbody td, #example-nav_left_Vision tbody td, #example-nav_left_Chapters tbody td, #example-nav_left_Verses tbody td, #s1 tbody td, #s2 tbody td, #s3 tbody td, #s4 tbody td, #s5 tbody td, #s6 tbody td, #s7 tbody td, #s8 tbody td, #s9 tbody td, #s10 tbody td, #s11 tbody td, #s12 tbody td, #example-browsing_mode_nav_left_Chapters tbody td, #example-browsing_mode_nav_left_Verses tbody td, .swiper_main_pagination, .show_sharing_options, .show_sending_options, .show_saving_options, ul.sm2-playlist-bd, .bd, .sm2-extra-controls, .sm2-inline-status, .sharing_modal_filter_mode, .fullscreen_offer, .sharing_modal_browsing_mode").removeClass("bgc-0001 bgc-0002 bgc-0003 bgc-0004 bgc-0005 bgc-0006 bgc-0007 bgc-0008 bgc-0009 bgc-0010 bgc-0011 bgc-0012 bgc-0013 bgc-0014 bgc-0015 bgc-0016").addClass("bgc-0008");
  ...
  $(".wrap_top_menu").find("#bgc-0009").on('click', function() {
    $(".wrap_top, .wrap_bot, .wrap_ajaxed, #wrap_ajaxed_cloned_status, #current_section, .wrap_nav_header, .wrap_nav_footer, .wrap_ref_header, .wrap_ref_footer, #example-nav_left_Books_status tbody td, #example-nav_left_Chapters_status tbody td, #example-nav_left_Verses_status tbody td, input.standard_input_reg, #example-nav_left_Teaching tbody td, #example-nav_left_FormerProphets tbody td, #example-nav_left_LatterProphets tbody td, #example-nav_left_TheTwelve tbody td, #example-nav_left_ScrollsOfTruth tbody td, #example-nav_left_FiveScrolls tbody td, #example-nav_left_OtherScrolls tbody td, #example-nav_left_Messiah tbody td, #example-nav_left_Emissaries tbody td, #example-nav_left_Assemblies tbody td, #example-nav_left_Disciples tbody td, #example-nav_left_Vision tbody td, #example-nav_left_Chapters tbody td, #example-nav_left_Verses tbody td, #s1 tbody td, #s2 tbody td, #s3 tbody td, #s4 tbody td, #s5 tbody td, #s6 tbody td, #s7 tbody td, #s8 tbody td, #s9 tbody td, #s10 tbody td, #s11 tbody td, #s12 tbody td, #example-browsing_mode_nav_left_Chapters tbody td, #example-browsing_mode_nav_left_Verses tbody td, .swiper_main_pagination, .show_sharing_options, .show_sending_options, .show_saving_options, ul.sm2-playlist-bd, .bd, .sm2-extra-controls, .sm2-inline-status, .sharing_modal_filter_mode, .fullscreen_offer, .sharing_modal_browsing_mode").removeClass("bgc-0001 bgc-0002 bgc-0003 bgc-0004 bgc-0005 bgc-0006 bgc-0007 bgc-0008 bgc-0009 bgc-0010 bgc-0011 bgc-0012 bgc-0013 bgc-0014 bgc-0015 bgc-0016").addClass("bgc-0009");
  ...
  $(".wrap_top_menu").find("#bgc-0010").on('click', function() {
    $(".wrap_top, .wrap_bot, .wrap_ajaxed, #wrap_ajaxed_cloned_status, #current_section, .wrap_nav_header, .wrap_nav_footer, .wrap_ref_header, .wrap_ref_footer, #example-nav_left_Books_status tbody td, #example-nav_left_Chapters_status tbody td, #example-nav_left_Verses_status tbody td, input.standard_input_reg, #example-nav_left_Teaching tbody td, #example-nav_left_FormerProphets tbody td, #example-nav_left_LatterProphets tbody td, #example-nav_left_TheTwelve tbody td, #example-nav_left_ScrollsOfTruth tbody td, #example-nav_left_FiveScrolls tbody td, #example-nav_left_OtherScrolls tbody td, #example-nav_left_Messiah tbody td, #example-nav_left_Emissaries tbody td, #example-nav_left_Assemblies tbody td, #example-nav_left_Disciples tbody td, #example-nav_left_Vision tbody td, #example-nav_left_Chapters tbody td, #example-nav_left_Verses tbody td, #s1 tbody td, #s2 tbody td, #s3 tbody td, #s4 tbody td, #s5 tbody td, #s6 tbody td, #s7 tbody td, #s8 tbody td, #s9 tbody td, #s10 tbody td, #s11 tbody td, #s12 tbody td, #example-browsing_mode_nav_left_Chapters tbody td, #example-browsing_mode_nav_left_Verses tbody td, .swiper_main_pagination, .show_sharing_options, .show_sending_options, .show_saving_options, ul.sm2-playlist-bd, .bd, .sm2-extra-controls, .sm2-inline-status, .sharing_modal_filter_mode, .fullscreen_offer, .sharing_modal_browsing_mode").removeClass("bgc-0001 bgc-0002 bgc-0003 bgc-0004 bgc-0005 bgc-0006 bgc-0007 bgc-0008 bgc-0009 bgc-0010 bgc-0011 bgc-0012 bgc-0013 bgc-0014 bgc-0015 bgc-0016").addClass("bgc-0010");
  ...
  $(".wrap_top_menu").find("#bgc-0011").on('click', function() {
    $(".wrap_top, .wrap_bot, .wrap_ajaxed, #wrap_ajaxed_cloned_status, #current_section, .wrap_nav_header, .wrap_nav_footer, .wrap_ref_header, .wrap_ref_footer, #example-nav_left_Books_status tbody td, #example-nav_left_Chapters_status tbody td, #example-nav_left_Verses_status tbody td, input.standard_input_reg, #example-nav_left_Teaching tbody td, #example-nav_left_FormerProphets tbody td, #example-nav_left_LatterProphets tbody td, #example-nav_left_TheTwelve tbody td, #example-nav_left_ScrollsOfTruth tbody td, #example-nav_left_FiveScrolls tbody td, #example-nav_left_OtherScrolls tbody td, #example-nav_left_Messiah tbody td, #example-nav_left_Emissaries tbody td, #example-nav_left_Assemblies tbody td, #example-nav_left_Disciples tbody td, #example-nav_left_Vision tbody td, #example-nav_left_Chapters tbody td, #example-nav_left_Verses tbody td, #s1 tbody td, #s2 tbody td, #s3 tbody td, #s4 tbody td, #s5 tbody td, #s6 tbody td, #s7 tbody td, #s8 tbody td, #s9 tbody td, #s10 tbody td, #s11 tbody td, #s12 tbody td, #example-browsing_mode_nav_left_Chapters tbody td, #example-browsing_mode_nav_left_Verses tbody td, .swiper_main_pagination, .show_sharing_options, .show_sending_options, .show_saving_options, ul.sm2-playlist-bd, .bd, .sm2-extra-controls, .sm2-inline-status, .sharing_modal_filter_mode, .fullscreen_offer, .sharing_modal_browsing_mode").removeClass("bgc-0001 bgc-0002 bgc-0003 bgc-0004 bgc-0005 bgc-0006 bgc-0007 bgc-0008 bgc-0009 bgc-0010 bgc-0011 bgc-0012 bgc-0013 bgc-0014 bgc-0015 bgc-0016").addClass("bgc-0011");
  ...
  $(".wrap_top_menu").find("#bgc-0012").on('click', function() {
    $(".wrap_top, .wrap_bot, .wrap_ajaxed, #wrap_ajaxed_cloned_status, #current_section, .wrap_nav_header, .wrap_nav_footer, .wrap_ref_header, .wrap_ref_footer, #example-nav_left_Books_status tbody td, #example-nav_left_Chapters_status tbody td, #example-nav_left_Verses_status tbody td, input.standard_input_reg, #example-nav_left_Teaching tbody td, #example-nav_left_FormerProphets tbody td, #example-nav_left_LatterProphets tbody td, #example-nav_left_TheTwelve tbody td, #example-nav_left_ScrollsOfTruth tbody td, #example-nav_left_FiveScrolls tbody td, #example-nav_left_OtherScrolls tbody td, #example-nav_left_Messiah tbody td, #example-nav_left_Emissaries tbody td, #example-nav_left_Assemblies tbody td, #example-nav_left_Disciples tbody td, #example-nav_left_Vision tbody td, #example-nav_left_Chapters tbody td, #example-nav_left_Verses tbody td, #s1 tbody td, #s2 tbody td, #s3 tbody td, #s4 tbody td, #s5 tbody td, #s6 tbody td, #s7 tbody td, #s8 tbody td, #s9 tbody td, #s10 tbody td, #s11 tbody td, #s12 tbody td, #example-browsing_mode_nav_left_Chapters tbody td, #example-browsing_mode_nav_left_Verses tbody td, .swiper_main_pagination, .show_sharing_options, .show_sending_options, .show_saving_options, ul.sm2-playlist-bd, .bd, .sm2-extra-controls, .sm2-inline-status, .sharing_modal_filter_mode, .fullscreen_offer, .sharing_modal_browsing_mode").removeClass("bgc-0001 bgc-0002 bgc-0003 bgc-0004 bgc-0005 bgc-0006 bgc-0007 bgc-0008 bgc-0009 bgc-0010 bgc-0011 bgc-0012 bgc-0013 bgc-0014 bgc-0015 bgc-0016").addClass("bgc-0012");
  ...
  $(".wrap_top_menu").find("#bgc-0013").on('click', function() {
    $(".wrap_top, .wrap_bot, .wrap_ajaxed, #wrap_ajaxed_cloned_status, #current_section, .wrap_nav_header, .wrap_nav_footer, .wrap_ref_header, .wrap_ref_footer, #example-nav_left_Books_status tbody td, #example-nav_left_Chapters_status tbody td, #example-nav_left_Verses_status tbody td, input.standard_input_reg, #example-nav_left_Teaching tbody td, #example-nav_left_FormerProphets tbody td, #example-nav_left_LatterProphets tbody td, #example-nav_left_TheTwelve tbody td, #example-nav_left_ScrollsOfTruth tbody td, #example-nav_left_FiveScrolls tbody td, #example-nav_left_OtherScrolls tbody td, #example-nav_left_Messiah tbody td, #example-nav_left_Emissaries tbody td, #example-nav_left_Assemblies tbody td, #example-nav_left_Disciples tbody td, #example-nav_left_Vision tbody td, #example-nav_left_Chapters tbody td, #example-nav_left_Verses tbody td, #s1 tbody td, #s2 tbody td, #s3 tbody td, #s4 tbody td, #s5 tbody td, #s6 tbody td, #s7 tbody td, #s8 tbody td, #s9 tbody td, #s10 tbody td, #s11 tbody td, #s12 tbody td, #example-browsing_mode_nav_left_Chapters tbody td, #example-browsing_mode_nav_left_Verses tbody td, .swiper_main_pagination, .show_sharing_options, .show_sending_options, .show_saving_options, ul.sm2-playlist-bd, .bd, .sm2-extra-controls, .sm2-inline-status, .sharing_modal_filter_mode, .fullscreen_offer, .sharing_modal_browsing_mode").removeClass("bgc-0001 bgc-0002 bgc-0003 bgc-0004 bgc-0005 bgc-0006 bgc-0007 bgc-0008 bgc-0009 bgc-0010 bgc-0011 bgc-0012 bgc-0013 bgc-0014 bgc-0015 bgc-0016").addClass("bgc-0013");
  ...
  $(".wrap_top_menu").find("#bgc-0014").on('click', function() {
    $(".wrap_top, .wrap_bot, .wrap_ajaxed, #wrap_ajaxed_cloned_status, #current_section, .wrap_nav_header, .wrap_nav_footer, .wrap_ref_header, .wrap_ref_footer, #example-nav_left_Books_status tbody td, #example-nav_left_Chapters_status tbody td, #example-nav_left_Verses_status tbody td, input.standard_input_reg, #example-nav_left_Teaching tbody td, #example-nav_left_FormerProphets tbody td, #example-nav_left_LatterProphets tbody td, #example-nav_left_TheTwelve tbody td, #example-nav_left_ScrollsOfTruth tbody td, #example-nav_left_FiveScrolls tbody td, #example-nav_left_OtherScrolls tbody td, #example-nav_left_Messiah tbody td, #example-nav_left_Emissaries tbody td, #example-nav_left_Assemblies tbody td, #example-nav_left_Disciples tbody td, #example-nav_left_Vision tbody td, #example-nav_left_Chapters tbody td, #example-nav_left_Verses tbody td, #s1 tbody td, #s2 tbody td, #s3 tbody td, #s4 tbody td, #s5 tbody td, #s6 tbody td, #s7 tbody td, #s8 tbody td, #s9 tbody td, #s10 tbody td, #s11 tbody td, #s12 tbody td, #example-browsing_mode_nav_left_Chapters tbody td, #example-browsing_mode_nav_left_Verses tbody td, .swiper_main_pagination, .show_sharing_options, .show_sending_options, .show_saving_options, ul.sm2-playlist-bd, .bd, .sm2-extra-controls, .sm2-inline-status, .sharing_modal_filter_mode, .fullscreen_offer, .sharing_modal_browsing_mode").removeClass("bgc-0001 bgc-0002 bgc-0003 bgc-0004 bgc-0005 bgc-0006 bgc-0007 bgc-0008 bgc-0009 bgc-0010 bgc-0011 bgc-0012 bgc-0013 bgc-0014 bgc-0015 bgc-0016").addClass("bgc-0014");
  ...
  $(".wrap_top_menu").find("#bgc-0015").on('click', function() {
    $(".wrap_top, .wrap_bot, .wrap_ajaxed, #wrap_ajaxed_cloned_status, #current_section, .wrap_nav_header, .wrap_nav_footer, .wrap_ref_header, .wrap_ref_footer, #example-nav_left_Books_status tbody td, #example-nav_left_Chapters_status tbody td, #example-nav_left_Verses_status tbody td, input.standard_input_reg, #example-nav_left_Teaching tbody td, #example-nav_left_FormerProphets tbody td, #example-nav_left_LatterProphets tbody td, #example-nav_left_TheTwelve tbody td, #example-nav_left_ScrollsOfTruth tbody td, #example-nav_left_FiveScrolls tbody td, #example-nav_left_OtherScrolls tbody td, #example-nav_left_Messiah tbody td, #example-nav_left_Emissaries tbody td, #example-nav_left_Assemblies tbody td, #example-nav_left_Disciples tbody td, #example-nav_left_Vision tbody td, #example-nav_left_Chapters tbody td, #example-nav_left_Verses tbody td, #s1 tbody td, #s2 tbody td, #s3 tbody td, #s4 tbody td, #s5 tbody td, #s6 tbody td, #s7 tbody td, #s8 tbody td, #s9 tbody td, #s10 tbody td, #s11 tbody td, #s12 tbody td, #example-browsing_mode_nav_left_Chapters tbody td, #example-browsing_mode_nav_left_Verses tbody td, .swiper_main_pagination, .show_sharing_options, .show_sending_options, .show_saving_options, ul.sm2-playlist-bd, .bd, .sm2-extra-controls, .sm2-inline-status, .sharing_modal_filter_mode, .fullscreen_offer, .sharing_modal_browsing_mode").removeClass("bgc-0001 bgc-0002 bgc-0003 bgc-0004 bgc-0005 bgc-0006 bgc-0007 bgc-0008 bgc-0009 bgc-0010 bgc-0011 bgc-0012 bgc-0013 bgc-0014 bgc-0015 bgc-0016").addClass("bgc-0015");
  ...
  $(".wrap_top_menu").find("#bgc-0016").on('click', function() {
    $(".wrap_top, .wrap_bot, .wrap_ajaxed, #wrap_ajaxed_cloned_status, #current_section, .wrap_nav_header, .wrap_nav_footer, .wrap_ref_header, .wrap_ref_footer, #example-nav_left_Books_status tbody td, #example-nav_left_Chapters_status tbody td, #example-nav_left_Verses_status tbody td, input.standard_input_reg, #example-nav_left_Teaching tbody td, #example-nav_left_FormerProphets tbody td, #example-nav_left_LatterProphets tbody td, #example-nav_left_TheTwelve tbody td, #example-nav_left_ScrollsOfTruth tbody td, #example-nav_left_FiveScrolls tbody td, #example-nav_left_OtherScrolls tbody td, #example-nav_left_Messiah tbody td, #example-nav_left_Emissaries tbody td, #example-nav_left_Assemblies tbody td, #example-nav_left_Disciples tbody td, #example-nav_left_Vision tbody td, #example-nav_left_Chapters tbody td, #example-nav_left_Verses tbody td, #s1 tbody td, #s2 tbody td, #s3 tbody td, #s4 tbody td, #s5 tbody td, #s6 tbody td, #s7 tbody td, #s8 tbody td, #s9 tbody td, #s10 tbody td, #s11 tbody td, #s12 tbody td, #example-browsing_mode_nav_left_Chapters tbody td, #example-browsing_mode_nav_left_Verses tbody td, .swiper_main_pagination, .show_sharing_options, .show_sending_options, .show_saving_options, ul.sm2-playlist-bd, .bd, .sm2-extra-controls, .sm2-inline-status, .sharing_modal_filter_mode, .fullscreen_offer, .sharing_modal_browsing_mode").removeClass("bgc-0001 bgc-0002 bgc-0003 bgc-0004 bgc-0005 bgc-0006 bgc-0007 bgc-0008 bgc-0009 bgc-0010 bgc-0011 bgc-0012 bgc-0013 bgc-0014 bgc-0015 bgc-0016").addClass("bgc-0016");
...
$(document).ready(function() {
  ...
  $("#to_search_grk").on('click', function() {
    $("#to_search_grk,#to_search_grk_tra,#to_search_es,#to_search_en,#to_search_heb_tra,#to_search_heb").hide("slow");
  ...
  $("#filter_grk").focusout(function() {
    ...
    $("#to_search_grk,#to_search_grk_tra,#to_search_es,#to_search_en,#to_search_heb_tra,#to_search_heb").show("slow");
  });
  // if grk_tra
  ...
  // if reg_esp
  $("#to_search_es").on('click', function() {
    $("#to_search_grk,#to_search_grk_tra,#to_search_es,#to_search_en,#to_search_heb_tra,#to_search_heb").hide("slow");
    $("#searching_es").css("display", "block").css("line-height", "45px").css("width", "100%").css("height", "45px");
    $("#filter_es").show("slow").css("display", "block").focus();
  });
  $("#filter_es").focusout(function() {
    $("#filter_es").hide("slow");
    $("#searching_es").css("display", "none").css("line-height", "0px").css("width", "0%").css("height", "0px");
    $("#to_search_grk,#to_search_grk_tra,#to_search_es,#to_search_en,#to_search_heb_tra,#to_search_heb").show("slow");
  });
  // if reg_eng
  $("#to_search_en").on('click', function() {
    $("#to_search_grk,#to_search_grk_tra,#to_search_es,#to_search_en,#to_search_heb_tra,#to_search_heb").hide("slow");
    $("#searching_en").css("display", "block").css("line-height", "45px").css("width", "100%").css("height", "45px");
    $("#filter_en").show("slow").css("display", "block").focus();
  ...
  $("#filter_en").focusout(function() {
    $("#filter_en").hide("slow");
    $("#searching_en").css("display", "none").css("line-height", "0px").css("width", "0%").css("height", "0px");
    $("#to_search_grk,#to_search_grk_tra,#to_search_es,#to_search_en,#to_search_heb_tra,#to_search_heb").show("slow");
  });
  // if heb_tra
...
// monitor with screenfull.isFullscreen to handle switches on and off
if (screenfull.enabled) {
	screenfull.on('change', () => {
		console.log('Am I fullscreen?', screenfull.isFullscreen ? 'Yes' : 'No');
if (screenfull.isFullscreen == true) {
$("#config_full_screen_on").addClass("active_switch");
$("#config_full_screen_off").removeClass("active_switch").removeAttr("style");
} else {
$("#config_full_screen_off").addClass("active_switch");
$("#config_full_screen_on").removeClass("active_switch").removeAttr("style");
}
	});
  // when we hit ESC key
...
// handle fullscreen_offer choices
$("#fullscreen_offer_yes").on('click', function() {
$(".wrap_fullscreen_offer").hide("slow");
$("#config_full_screen_on").trigger({type: 'click', which: 1});
});
$("#fullscreen_offer_no").on('click', function() {
$(".wrap_fullscreen_offer").hide("slow");
});
/////////////////////////////////////////
// END screenfull
...
///////////////////////////////////////////////////
/// BEGIN handle click on change_automation_settings  ///////
///////////////////////////////////////////////////
  $("#change_automation_settings").on('click', function(e) {
    // hide the modal
    $(".wrap_fullscreen_offer").hide();
// BEGIN handle the toggle to automation settings
    ...
    // check if we need to open automation settings
    if (( !$("#scrollTo_top_menu_items_fullscreen_preferences_trigger_close").css('display') != 'none' )) {
    setTimeout(function() {
      if (!$("#scrollTo_top_menu_items_fullscreen_preferences_landing").hasClass("active")) {
      $(".wrap_top_menu").find("#scrollTo_top_menu_items_fullscreen_preferences_landing").trigger({
            type: 'click',
            which: 1
          });
      $(".wrap_top_menu").find("#scrollTo_top_menu_items_fullscreen_preferences_trigger_open").trigger({
            type: 'click',
            which: 1
          });
      } else {
  ...
  // END handle the toggle to automation settings
  // BEGIN handle the toggle to be able to click again and close after doing some automation settings
    if ( ($('.wrap_top_menu').hasClass('wrap_top_menu_active')) && ($("#scrollTo_top_menu_items_fullscreen_preferences_landing").hasClass("active")) ) {
      setTimeout(function() {
      $('.top_menu').trigger({type: 'click', which: 1});
      $('.wrap_top_menu').removeClass('wrap_top_menu_active').hide();
      }, 500);
    }
  // END handle the toggle to be able to click again and close after doing some automation settings
});
///////////////////////////////////////////////////
/// END handle click on change_automation_settings  ///////
///////////////////////////////////////////////////
