...
'<td class="column_0_case_1_a"><div class="dt_inner_cell col_image"><img class="retrieved_image" src="' + data_case_1_a[key].column_0_case_1_a + '" alt=""></div><div class="dt_inner_cell col_date">' + data_case_1_a[key].column_1_case_1_a + '</div><div class="dt_inner_cell col_title">' + data_case_1_a[key].column_2_case_1_a + '</div><div class="dt_inner_cell col_desc">' + data_case_1_a[key].column_3_case_1_a + '</div><div class="dt_inner_cell col_extra1">' + data_case_1_a[key].column_4_case_1_a + '</div><div class="dt_inner_cell col_extra2">' + data_case_1_a[key].column_5_case_1_a + '</div></td>' +
...
setTimeout(function() {
  ...
  ////////////////////////////////////////
  if (
    $("table.table_case_1_a thead tr th:eq(2)").css("display") == "none" &&
    $("table.table_case_1_a thead tr th:eq(3)").css("display") == "none" &&
    $("table.table_case_1_a thead tr th:eq(4)").css("display") == "none" &&
    $("table.table_case_1_a thead tr th:eq(5)").css("display") == "none" &&
    $("table.table_case_1_a thead tr th:eq(6)").css("display") == "none"
  ) {
    setTimeout(function() {
      $("table.table_case_1_a thead tr th.control")
        .css("color", "yellow")
        .css("width", "44px");
      $("table.table_case_1_a thead tr th:eq(1)")
        .css("color", "yellow")
        .css("width", "100%");
    ...
    setTimeout(function() {
      ...
      $("table.table_case_1_a thead tr th:eq(1)")
        .css("color", "orange")
        .css("width", "50%");
      $("table.table_case_1_a thead tr th:eq(2)")
        .css("color", "orange")
        .css("width", "50%");
      $("table.table_case_1_a tbody tr").each(function() {
        $(this)
    ...
    setTimeout(function() {
      ...
      $("table.table_case_1_a thead tr th:eq(2)")
        .css("color", "hotpink")
        .css("width", "33.33%");
      $("table.table_case_1_a thead tr th:eq(3)")
        .css("color", "hotpink")
        .css("width", "33.33%");
      $("table.table_case_1_a tbody tr").each(function() {
        $(this)
    ...
    setTimeout(function() {
      ...
      $("table.table_case_1_a thead tr th:eq(3)")
        .css("color", "hotpink")
        .css("width", "25%");
      $("table.table_case_1_a thead tr th:eq(4)")
        .css("color", "hotpink")
        .css("width", "25%");
      $("table.table_case_1_a tbody tr").each(function() {
        $(this)
...
/////////////////////////////////////////////////////////////////////////
///// BEGIN detect if mobile/tablet/touch /////////
/////////////////////////////////////////////////////////////////////////
            ...
            details: {
                ...
                renderer: function ( api, rowIdx, columns ) {
                    var data = $.map( columns, function ( col, i ) {
                        return col.hidden ?
                            '<table class="resp_ch_row_table"><tr class="resp_ch_row_tr" data-dt-row="'+col.rowIndex+'" data-dt-column="'+col.columnIndex+'">'+
// removed the '+col.title+'     '<td><div class="responsive_col_title">'+col.title+'</div></td> '+
                            '<td><div class="responsive_col_title"></div></td> '+
                                '<td><div class="responsive_editing">'+col.data+'</div></td>'+
                            '</tr></table>' :
                            '';
                    } ).join('');
...
|| (!$('#email').text().match('smuglovsky.code@gmail.com'))
|| (!$('#email').text().match('joseoweb@gmail.com'))) {
...
var check_if_an_admin_is_logged_in = setInterval(function() {
  ...
  || ($("#email").text() == 'smuglovsky.code@gmail.com')
  || ($("#email").text() == 'joseoweb@gmail.com')) {
...
$("#lock_is_open").show();
$("td.column_edit").show();
$("td.column_delete").show();
$("body").find(".resp_ch_row_tr").find('td:nth-child(1)').show();
$("body").find(".create_case_1_a").show();
$(".title_case_1_a").css("color", "red");
} else {
...
// BEGIN resize Ad images only based on Portrait or Landscape
var check_if_Portrait_or_Landscape = setInterval(function() {

var windowWidth = $(window).width();
var windowHeight = $(window).height();
var adImagesForPortrait = $('img').each(function(){
   if ( (this.src.indexOf(".png.png") != -1) && ( windowWidth < windowHeight ) ) {
// $(this).css("max-width", "20px");
}
});
var adImagesForLandscape = $('img').each(function(){
   if ( (this.src.indexOf(".png.png") != -1) && ( windowWidth > windowHeight ) ) {
