...
// rename menu books
$("body").find(".menu_book_reg:contains('1 John')").html("1 João");
$("body").find(".menu_book_reg:contains('2 John')").html("2 João");
$("body").find(".menu_book_reg:contains('3 John')").html("3 João");
$("body").find(".menu_book_reg:contains('Genesis')").html("Gênesis");
$("body").find(".menu_book_reg:contains('Exodus')").html("Êxodo");
$("body").find(".menu_book_reg:contains('Leviticus')").html("Levítico");
$("body").find(".menu_book_reg:contains('Numbers')").html("Números");
$("body").find(".menu_book_reg:contains('Deuteronomy')").html("Deuteronômio");
$("body").find(".menu_book_reg:contains('Joshua')").html("Josué");
$("body").find(".menu_book_reg:contains('Judges')").html("Juízes");
$("body").find(".menu_book_reg:contains('1 Samuel')").html("1 Samuel");
$("body").find(".menu_book_reg:contains('2 Samuel')").html("2 Samuel");
$("body").find(".menu_book_reg:contains('1 Kings')").html("1 Reis");
$("body").find(".menu_book_reg:contains('2 Kings')").html("2 Reis");
$("body").find(".menu_book_reg:contains('Isaiah')").html("Isaías");
$("body").find(".menu_book_reg:contains('Jeremiah')").html("Jeremias");
$("body").find(".menu_book_reg:contains('Ezekiel')").html("Ezequiel");
$("body").find(".menu_book_reg:contains('Daniel')").html("Daniel");
$("body").find(".menu_book_reg:contains('Hosea')").html("Oséias");
$("body").find(".menu_book_reg:contains('Joel')").html("Joel");
$("body").find(".menu_book_reg:contains('Amos')").html("Amós");
$("body").find(".menu_book_reg:contains('Obadiah')").html("Obadias");
$("body").find(".menu_book_reg:contains('Jonah')").html("Jonas");
$("body").find(".menu_book_reg:contains('Micah')").html("Miquéias");
$("body").find(".menu_book_reg:contains('Nahum')").html("Naum");
$("body").find(".menu_book_reg:contains('Habakkuk')").html("Habacuque");
$("body").find(".menu_book_reg:contains('Zephaniah')").html("Sofonias");
$("body").find(".menu_book_reg:contains('Haggai')").html("Ageu");
$("body").find(".menu_book_reg:contains('Zechariah')").html("Zacarias");
$("body").find(".menu_book_reg:contains('Malachi')").html("Malaquias");
$("body").find(".menu_book_reg:contains('Psalms')").html("Salmos");
$("body").find(".menu_book_reg:contains('Proverbs')").html("Provérbios");
$("body").find(".menu_book_reg:contains('Job')").html("Jó");
$("body").find(".menu_book_reg:contains('Song of Songs')").html("Cântico dos Cânticos");
$("body").find(".menu_book_reg:contains('Ruth')").html("Rute");
$("body").find(".menu_book_reg:contains('Lamentations')").html("Lamentações");
$("body").find(".menu_book_reg:contains('Ecclesiastes')").html("Eclesiastes");
$("body").find(".menu_book_reg:contains('Esther')").html("Ester");
$("body").find(".menu_book_reg:contains('Ezra')").html("Esdras");
$("body").find(".menu_book_reg:contains('Nehemiah')").html("Neemias");
$("body").find(".menu_book_reg:contains('1 Chronicles')").html("1 Crônicas");
$("body").find(".menu_book_reg:contains('2 Chronicles')").html("2 Crônicas");
$("body").find(".menu_book_reg:contains('John')").html("João");
$("body").find(".menu_book_reg:contains('Matthew')").html("Mateus");
$("body").find(".menu_book_reg:contains('Mark')").html("Marcos");
$("body").find(".menu_book_reg:contains('Luke')").html("Lucas");
$("body").find(".menu_book_reg:contains('Acts')").html("Atos");
$("body").find(".menu_book_reg:contains('Romans')").html("Romanos");
$("body").find(".menu_book_reg:contains('1 Corinthians')").html("1 Coríntios");
$("body").find(".menu_book_reg:contains('2 Corinthians')").html("2 Coríntios");
$("body").find(".menu_book_reg:contains('Galatians')").html("Gálatas");
$("body").find(".menu_book_reg:contains('Ephesians')").html("Efésios");
$("body").find(".menu_book_reg:contains('Philippians')").html("Filipenses");
$("body").find(".menu_book_reg:contains('Colossians')").html("Colossenses");
$("body").find(".menu_book_reg:contains('1 Thessalonians')").html("1 Tessalonicenses");
$("body").find(".menu_book_reg:contains('2 Thessalonians')").html("2 Tessalonicenses");
$("body").find(".menu_book_reg:contains('1 Timothy')").html("1 Timóteo");
$("body").find(".menu_book_reg:contains('2 Timothy')").html("2 Timóteo");
$("body").find(".menu_book_reg:contains('Titus')").html("Tito");
$("body").find(".menu_book_reg:contains('Philemon')").html("Filemon");
$("body").find(".menu_book_reg:contains('Hebrews')").html("Hebreus");
$("body").find(".menu_book_reg:contains('James')").html("Tiago");
...
$("body").find(".menu_book_reg:contains('Revelation')").html("Apocalipse");
}
}, 1100);
