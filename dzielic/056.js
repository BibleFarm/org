...
console.log("-*/-*/-*/-*/-*/-*/-*/-*/-*/-*/-*/-*/-*/-*/-*/-*/-*/-*/-*/-*/-*/-*/-*/-*/-*/-*/-*/-*/-*/-*/-*/-*/-*/-*/-*/-*/-*/-*/ changed bottom to current user's name");
  ...
  setTimeout(function() {
  $(".app_wrap").find("p.msg1").text("dzięki za odwiedziny").fadeOut("5000").fadeIn("7000");
}, 8000);
}
...
if ($.trim($("#edited_app_name").text()) == "Twoje Imię Idzie Tutaj") {
...
///////////////////////////////////////////////////
/// BEGIN handle click on Twoje Imię Idzie Tutaj or logged in user  ///////
///////////////////////////////////////////////////
...
///////////////////////////////////////////////////
/// END handle click on Twoje Imię Idzie Tutaj or logged in user  ///////
///////////////////////////////////////////////////
...
$(document).ready(function() {
  ...
  console.log(origin);
    ...
    if( (url == "https://www.biblefarm.org/app/#login" ) && ($("#edited_app_name").text() == "Twoje Imię Idzie Tutaj") ) {
...
///////////////////////////////////////////////
////BEGIN clicking on bottom right ref selects audio
///////////////////////////////////////////////
...
$("body").find("button[data-provider-id='google.com']").find(".firebaseui-idp-text-long").text("Zaloguj się przez Google").css("text-shadow", "0px 0px 1px #000").css("font-family", "PT_Sans-Narrow-Web-Regular").css("font-size", "20px");
$("body").find("button[data-provider-id='facebook.com']").find(".firebaseui-idp-text-long").text("Zaloguj się przez Facebook").css("text-shadow", "1px 1px 1px #000").css("font-family", "PT_Sans-Narrow-Web-Regular").css("font-size", "20px");
$("body").find("button[data-provider-id='twitter.com']").find(".firebaseui-idp-text-long").text("Zaloguj się przez Twitter").css("text-shadow", "1px 1px 1px #000").css("font-family", "PT_Sans-Narrow-Web-Regular").css("font-size", "20px");
$("body").find("button[data-provider-id='password']").find(".firebaseui-idp-text-long").text("Zaloguj się przez Email").css("text-shadow", "1px 1px 1px #000").css("font-family", "PT_Sans-Narrow-Web-Regular").css("font-size", "20px");
}
}, 1000);
// after we signed out
