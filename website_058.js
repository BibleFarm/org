...
console.log("///////////////////// began fbFetch function");
  ...
  ////////////////////////////////////////////////////
  $("body")
    .find(".wrap_visit_GoFundMe_campaigns")
    .on("click", function() {
  ...
  $("body")
    ...
    .on("click", function() {
      ...
      setTimeout(function() {
        ...
        console.log(
          "///////// waited 500 millisecs to slick reinit lazy_responsive"
        );
      }, 500);
      setTimeout(function() {
        $(".lazy_farm").slick("reinit");
...
// modal loads hidden
$(
  ".wrap_sharing_modal_for_requested_access, .wrap_sharing_panel, .modal_multi_item_share_bf_yes_or_no, .modal_multi_item_share_bf_again_or_done, .maybe_next_time_redirect, .reqesting_app_shared_no, .that_was_awesome_redirect, .reqesting_app_shared_yes, .show_appreciation_for_sharing_again"
).hide();
// show the modal
$(".requeest_bf_app_access").on("click", function() {
  $(
    ".wrap_sharing_modal_for_requested_access, .wrap_sharing_panel, .nope_im_not_sharing"
  ).show("slow");
...
$(".nope_im_not_sharing").on("click", function() {
  $(
    ".wrap_sharing_modal_for_requested_access, .wrap_sharing_panel, .modal_multi_item_share_bf_yes_or_no, .modal_multi_item_share_bf_again_or_done, .requeest_bf_app_access"
  ).hide();
...
$(".maybe_next_time_redirect, .that_was_awesome_redirect").on(
  "click",
  function() {
    $(
      ".maybe_next_time_redirect, .reqesting_app_shared_no, .that_was_awesome_redirect, .reqesting_app_shared_yes"
    ).hide();
